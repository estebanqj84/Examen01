...
var createDecorator = VueClassComponent.createDecorator;
var AsyncComputedProp = function (computedOptions) {
    return createDecorator(function (options, key) {
        var methodOriginal = options.methods[key];
        delete options.methods[key];
        options.asyncComputed = options.asyncComputed || {};
        computedOptions = computedOptions || {};

        computedOptions["get"] = methodOriginal;
        options.asyncComputed[key] = computedOptions;
       
    });
};


var AsyncComputedProp = function () {
    return createDecorator(function (options, key) {
        var methodOriginal = options.methods[key];
        delete options.methods[key];
        options.asyncComputed = options.asyncComputed || {};
        options.asyncComputed[key] = methodOriginal;
    });
};